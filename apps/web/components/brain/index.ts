// Public entry point for brain-viz consumers.
//
// frontend-dashboard imports BrainMesh by name; the TimelineScrubber is
// the companion HTML control for the Detail view.

export { BrainMesh, default } from "./BrainMesh";
