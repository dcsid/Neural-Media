...
// Same dynamic import pattern as the /predict hero — R3F touches browser globals
...
export default function DemoGalleryPage() {
  ...
  return (
    <main className="mx-auto max-w-[1440px] px-5 pb-16 pt-12 sm:px-8">
      <DemoModeBanner cta={{ href: "/predict", label: "Predict your own clip →" }}>
...
// Region activation bars + valueAt now live in
// components/brain/RegionBars.tsx (shared with the live single-video result).
